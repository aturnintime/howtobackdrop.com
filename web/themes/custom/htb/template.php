...
/**
 * @file
 * HtB preprocess functions and theme function overrides.
 */
 ...
 * @see page.tpl.php
 */
function htb_preprocess_page(&$variables) {
 ...
 */
function htb_preprocess_maintenance_page(&$variables) {
  $css_path = backdrop_get_path('theme', 'htb') . '/css/component/maintenance.css';
 ...
 * @see layout.tpl.php
 */
function htb_preprocess_layout(&$variables) {
 ...
 * @see node.tpl.php
 */
function htb_preprocess_node(&$variables) {
 ...
 * @see header.tpl.php
 */
function htb_preprocess_header(&$variables) {
  $logo = $variables['logo'];
 ...
 */
function htb_breadcrumb($variables) {
